...
handler.add_lib(require("__CursorEnhancements__/migrations"))
...
handler.add_lib(require("__CursorEnhancements__/scroll-subgroup"))
handler.add_lib(require("__CursorEnhancements__/smarter-pipette"))
